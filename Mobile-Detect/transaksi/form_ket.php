...
$query=pg_query("select * from t_notice where no_polisi = '$nopol' and	flag_notice = '$flag'")or die(mysql_error());
			...
			$catatan  			=$row['catatan'];
			$nopolnya  			=$row['no_polisi'];
			$flagnya 			=$row['flag_notice'];
			?>           
                
	<div class="panel-title" align="center">TAMBAH CATATAN</div> 
            ...
            <div style="padding-top:30px" class="panel-body">
				<div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div> 
					<form id="loginform" class="form-horizontal" role="form">
					   ...
					   <tr>
                	<td width="23%" height="41"><div align="center"><b>Catatan Pembatalan</b></div></td>
                          <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
								<input class="form-control" type="hidden" name="nopol" value="<?php echo $nopolnya; ?>" >
								<input class="form-control" type="hidden" name="flag" value="<?php echo $flagnya; ?>" >
                                <textarea id="login-username" type="text" class="form-control" name="ket" placeholder="Catatan Pembatalan" required="required"><?php echo $catatan; ?></textarea>                                        
                          </div>
						  </tr>
