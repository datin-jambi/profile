...
header("Content-Disposition: attachment; filename=transaksi_perhari.xls");
...
<body>
		...
		<?php error_reporting (0);
			...
			$query=pg_query("select * from t_log_trn a, t_nm_lokasi b where a.tg_daftar = '$tglskrng' and LEFT(a.kd_lokasi,2) = '$lok' and
			a.kd_lokasi = b.kd_lokasi order by jam_proses DESC")or die(mysql_error());
