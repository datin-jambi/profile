...
*/
    ...
    // Hitung periode dan jarak bulan untuk setiap tunggakan
    $pkb_periode = array();
    $pkb_bulan_terlambat = array();
    ...
    if (!empty($datakb['tg_akhir_pkb'])) {
        ...
        for ($i = 0; $i <= 5; $i++) {
            ...
            // Hitung periode untuk index ini
            // Index 0 = tahun berjalan (terbaru), index 4 = tunggakan terlama
            if ($pok != 0) {
            ...
            // Hitung bulan terlambat untuk index ini
            $bulan = $sel_tgl['m'] + ($i * 12);
            if ($bulan > 24) $bulan = 24;
            $pkb_bulan_terlambat[$i] = $i > 0 ? $bulan : $sel_tgl['m'];
        }
    }
    
    $datakb['pkb_periode'] = $pkb_periode;
    $datakb['pkb_bulan_terlambat'] = $pkb_bulan_terlambat;
...
<html lang="en" class="no-js">
    ...
    <body class="cbp-spmenu-push">
        <div class="container">
            <a href="../pkb.old.html" class="btn btn-default">Menu Utama</a>
            ...
            <div id="det_pkb">
                <h4>RINCIAN PKB:</h4>
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-3">
                            <p class="text-center" style="font-weight: bold; font-size: 12px;">JARAK BULAN</p> 
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-3">
                ...
                $pkb_periode = $datakb['pkb_periode'];
                $pkb_bulan_terlambat = $datakb['pkb_bulan_terlambat'];
                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-3">
                            <p class="text-right" <?php echo $style ?>><?php echo $pkb_bulan_terlambat[$i] ?></p> 
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-3">
                            <p class="text-right" <?php echo $style ?>><?php echo $pkb_periode[$i] ?></p> 
                        </div>
                    </div>
                <?php } ?>
            </div>
