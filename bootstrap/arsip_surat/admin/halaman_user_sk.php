    ...
    <div id="wrapper" style="background:#003">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background:#003">
                ...
                <a class="navbar-brand" href="#" style="background:#003">Arsip Surat BPKPD <?php echo $_SESSION['bidang']; ?></a>
            ...
            <ul class="nav navbar-right top-nav" style="background:#003">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $_SESSION['bidang']; ?> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                                 <li>
                            <a href="?mod=setting_user"><i class="fa fa-fw fa-user"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                        <li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="background:#003">
                <ul class="nav navbar-nav side-nav" style="background:#003">
                    <li>
                        <a href="?mod=utama_user"><i class="fa fa-fw fa-dashboard"></i> Utama</a>
                    </li>
                    <li>
                        <a href="?mod=data_pegawai"><i class="fa fa-fw fa-dashboard"></i> Data Anggota</a>
                    </li>
                    <li>
                        <a href="?mod=surat"><i class="fa fa-fw fa-dashboard"></i> Data Arsip Surat</a>
                    </li>
<!--
                    <li>
                        <a href="?mod=arsip_surat_user"><i class="fa fa-fw fa-dashboard"></i> Data Arsip Surat</a>
                    </li> -->
