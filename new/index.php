        ...
        <main class="main-content">
            <div class="container mx-auto px-4 py-4 lg:py-0 w-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
                    ...
                    <!-- Data Kendaraan -->
                    <a href="./Service/Info-KB" 
                    class="bg-white/95 backdrop-blur-md hover:bg-white text-gray-800 font-semibold py-4 lg:py-5 px-4 lg:px-5 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border-l-4 border-blue-500 block focus:outline-none focus:ring-2 focus:ring-blue-400">
                        <div class="text-left">
                    ...
                    <!-- Pajak Kendaraan -->
                    <a href="./Service/Info-PKB" 
                    class="bg-white/95 backdrop-blur-md hover:bg-white text-gray-800 font-semibold py-4 lg:py-5 px-4 lg:px-5 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border-l-4 border-green-500 block focus:outline-none focus:ring-2 focus:ring-green-400">
                        <div class="text-left">
                    ...
                    <!-- Nilai Jual -->
                    <a href="nilaijual/form_nb.php" 
                    class="bg-white/95 backdrop-blur-md hover:bg-white text-gray-800 font-semibold py-4 lg:py-5 px-4 lg:px-5 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border-l-4 border-purple-500 block focus:outline-none focus:ring-2 focus:ring-purple-400">
                        <div class="text-left">
                    ...
                    <!-- Whistleblowing -->
                    <a href="./Service/Whistle" 
                    class="bg-white/95 backdrop-blur-md hover:bg-white text-gray-800 font-semibold py-4 lg:py-5 px-4 lg:px-5 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border-l-4 border-red-500 block focus:outline-none focus:ring-2 focus:ring-red-400">
                        <div class="text-left">
                    ...
                    class="bg-white/95 backdrop-blur-md hover:bg-white text-gray-800 font-semibold py-4 lg:py-5 px-4 lg:px-5 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border-l-4 border-teal-500 block focus:outline-none focus:ring-2 focus:ring-teal-400">
                        <div class="text-left">
                    ...
                    <!-- Pelayanan Publik -->
                    <a href="tentang.html" 
                    class="bg-white/95 backdrop-blur-md hover:bg-white text-gray-800 font-semibold py-4 lg:py-5 px-4 lg:px-5 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border-l-4 border-pink-500 block focus:outline-none focus:ring-2 focus:ring-pink-400">
                        <div class="text-left">
